...
class ImageWorkflow(object):
    ...
    def archive(self, *args, **kwargs):
        image = kwargs['image']
        archive_project = kwargs['archive_project']
    ...
    def audit(self, *args, **kwargs):
        ...
        official_projects = [
            '28eadf5ad64b42a4929b2fb7df99275c',  # NeCTAR-Images
            'c9217cb583f24c7f96567a4d6530e405',  # NeCTAR-Images-Archive
        ]
...
def main():
    ...
    parser.add_argument('-p', '--project',
                        default='28eadf5ad64b42a4929b2fb7df99275c',  # NeCTAR-Images
                        help='Project')
    parser.add_argument('-a', '--archive-project',
                        default='c9217cb583f24c7f96567a4d6530e405',  # NeCTAR-Images-Archive
