...
apt-get install -y --force-yes dh-systemd openstack-pkg-tools python-sphinx python3-setuptools libcurl3 python-glanceclient python-designateclient python-hivemind python-hivemind-contrib
