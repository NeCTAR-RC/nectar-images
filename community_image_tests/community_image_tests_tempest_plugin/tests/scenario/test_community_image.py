...
from community_image_tests_tempest_plugin.services.v2.community_image_client import CommunityImagesClient \
...
class TestCommunityImage(manager.ScenarioTest):
    ...
    * check command outputs
    ...
    def test_community_image(self):
        ...
        self.assertEqual('Expected 1 %s key, but found %s' % ('root',rootkey.strip()), '1', rootkey.strip())
        ...
        self.assertEqual('Expected 1 %s key, but found %s' % ('user',userkey.strip()), '1', userkey.strip())
